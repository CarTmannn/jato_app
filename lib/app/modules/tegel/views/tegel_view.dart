...
class FillOrder extends StatelessWidget {
  const FillOrder({
    super.key,
    required this.desc,
    required this.userRegisterView,
  ...
  final UserRegisterView userRegisterView;
  final RegisterController registerController;
  final ProfileController profileController;
  final TextEditingController min;
  final TextEditingController max;
  final TegelController controller;
  final type;
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child:
                                Text(profileController.user.value.alamat ?? ""),
                          ),
                          decoration: BoxDecoration(
                              color: Color(0XFFf3f3f3),
                              borderRadius: BorderRadius.circular(5)),
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                        profileController.user.value.provinsi ??
                                            ""),
                                  ),
                                  decoration: BoxDecoration(
                                      color: Color(0XFFf3f3f3),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text("Berapa biaya yang anda tawarkan kepada tukang?"),
                      SizedBox(
                        height: 10,
                      ),
                      Row(
